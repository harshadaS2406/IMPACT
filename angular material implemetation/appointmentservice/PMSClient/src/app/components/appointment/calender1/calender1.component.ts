...
import { DataService } from '../../appointmemt/calendar/data.service';
...
export class Calender1Component implements AfterViewInit {
  ...
  constructor(private ds: DataService) {  this.viewWeek();}
